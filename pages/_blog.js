								...
								<div className="post">
									<div className="image">
										<Link href="/blog_post">
											<a className="post-thumbnail">
												<Image
													src="/../public/images/blog/blog_4.jpg"
													width={"100%"}
													height={"100%"}
									...
									<div className="desc">
										...
										<div className="single-post-text">
											<p>
												So striking at of to welcomed
												resolved. Northward by described
												up household therefore
												attention. Excellence decisively
												nay man yet impression for
